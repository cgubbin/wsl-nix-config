...
local auto_backslash_snippet = require("utils.scaffolding").auto_backslash_snippet
local symbol_snippet = require("utils.scaffolding").symbol_snippet
local single_command_snippet = require("utils.scaffolding").single_command_snippet
local postfix_snippet = require("utils.scaffolding").postfix_snippet
local get_visual = require("utils.scaffolding").get_visual
...
for _, v in ipairs(auto_backslash_specs) do
    table.insert(auto_backslash_snippets,
